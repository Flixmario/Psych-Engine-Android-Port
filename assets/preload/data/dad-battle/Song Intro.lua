...
IntroTagColor = 'edd55b' --Color of the tag at the end of the box.
...
setTextSize('JukeBoxText', IntroTextSize)
    setTextColor('JukeBoxText', 'fff200')
addLuaText('JukeBoxText')

--text for the song name
makeLuaText('JukeBoxSubText', 'Tenzubushi', 300, -305-IntroTagWidth, 60)
